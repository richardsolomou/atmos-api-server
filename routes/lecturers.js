module.exports = function (server, connection, prefix, restify) {
	...
	server.post(prefix + '/lecturers', function (req, res, next) {
		connection.query('INSERT INTO `lecturers` VALUES (:lecturer_id, :lecturer_name, :lecturer_email)', { lecturer_id: req.params.lecturer_id, lecturer_name: req.params.lecturer_name, lecturer_email: req.params.lecturer_email }, function (err, results) {
			if (err) return next(err);
